...
%   Detailed explanation goes here
    ...
    QoS_GP_CONF = {
        {...
            struct('gid', 0.0, 'qos', 0.0, 'rbf_w', 2.0, 'rbf_h', 1.0, 'sinr_max', 23.712045618855058, 'pwr_req_dBm', 22.973, 'pwr_ext_dBm', 0.9223015226843518, 'rem_bits', 4712.0, 'mem_num', 71.0, 'eager_rate', 36.63437309374906)...
        },...
        {...
